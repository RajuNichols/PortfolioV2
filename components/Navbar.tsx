						...
						<div className="flex items-center mx-14  justify-between w-full">
							<div className="flex justify-center items-center flex-shrink-0 ">
								<Link
										...
										offset={0}
										duration={500}
										className="cursor-pointer text-black py-2 rounded-md text-xl font-large"
									>
										Raju Nichols
									</Link>
							</div>
				...
				>
					{(ref) => (
						<div className="md:hidden" id="mobile-menu">
							...
							>
								<Scrollspy items={['home', 'skills', 'projects', 'contact']} currentClassName="active" className="flex flex-col">
										<Link
										to="home"
										smooth={true}
										offset={0}
